...
public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
    ...
    public static double PERPENDICULAR_X = 2.75591;
    public static double PERPENDICULAR_Y = -6.102362;

    public static double X_MULTIPLIER = 0; // Multiplier in the X direction
    public static double Y_MULTIPLIER = 0; // Multiplier in the Y direction
